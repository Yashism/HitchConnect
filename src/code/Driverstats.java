...
public class Driverstats {
    ...
    public static String[] userAndPass = new String[3];
            ...
            public void actionPerformed(ActionEvent e) {
                if (e.getSource() == button1) {
                    if(find_driver(textfield.getText())){
                        JOptionPane.showMessageDialog(null, "Driver found: " + userAndPass[0] + " drives a " + userAndPass[1] + " plate No: "+ userAndPass[3]);
                    }
                    else{
